...
const AI_PLATFORM_STATUS_TOOLTIP =
  'This status is generated by AI and requires human validation.';
...
const COLUMN_TOOLTIPS: Partial<Record<(typeof TABLE_COLUMNS)[number], string>> = {
  'AI PLATFORM STATUS': AI_PLATFORM_STATUS_TOOLTIP,
};
